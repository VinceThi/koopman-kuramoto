...
B = np.array(np.load(path/"us_agencies__newyork.npy"))  # For advogato: [4017, 4020, 4021, 3512]
N = len(B[:, 0])


# TODO enregistrer : le nb de cross-ratios, les tailles des motifs et les degrés in max intramotif
...
nb_cross_ratio_motifs = count_cross_ratio_motifs(B, S)
...
print(f"N = {N}",
      ...
      f"\nnb cross-ratios motifs = {nb_cross_ratio_motifs}")

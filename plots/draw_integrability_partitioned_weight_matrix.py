...
plot_weight_matrix = True
plot_weight_distribution = False
plot_out_degree_distribution = False
draw_function = "graph_draw"

""" Generate the weight matrix """
sizes_monomial = [2, 3, 5, 10, 130]
sizes_crossratio = [4, 24, 80, 100]
size_nonintegrable = [142]
...
probabilities_monomial = [1, 1, 0.9, 0.8, 0.05]
probabilities_crossratio = [[0, 0.1, 0, 0.01, 0.01, 0.8, 0.05, 0.001, 0, 0.01],
                            [0.1, 0, 0, 0, 0.01, 0.01, 0.5, 0.01, 0, 0.01],
                            [0, 0, 0.1, 0, 0.001, 0.1, 0.1, 0.5, 0, 0.01],
                            [0.1, 0, 0, 0.01, 0, 0.1, 0, 0, 0.3, 0.002]]
probabilities_nonintegrable = [0.05, 0.01, 0.01, 0.005, 0.001, 0.1, 0.1, 0.05, 0.002, 0.001]
...
hex_colors_short = ["#FFB38E","#FFCF9D","#FFB26F","#DE8F5F","#DD8452","#87D0FA","#3C7A89","#2E4756","#16262E","#AAAAAA"]

...
ax3.plot(np.linspace(0, 100, n_iter), [np.pi/2 for i in range(n_iter)], "black", lw=0.4)
ax3.plot(np.linspace(0, 100, n_iter), [-np.pi/2 for i in range(n_iter)], "black", lw=0.4)
...
line2, = ax2.plot([], [], ".", markersize=1, label="$\delta_{12}$", color=reduced_first_community_color)
line3, = ax2.plot([], [], ".", markersize=1, label="$\delta_{23}$", color=reduced_second_community_color)
line4, = ax2.plot([], [], ".", markersize=1, label="$\delta_{34}$", color=reduced_third_community_color)
line5, = ax2.plot([], [], ".", markersize=1, label="$\delta_{41}$", color=reduced_fourth_community_color)
...
line6, = ax3.plot([], [], ".", markersize=1, linewidth=0.5, label="$\sigma_{12}/2 - θ_0$", color=reduced_first_community_color)
line7, = ax3.plot([], [], ".", markersize=1, linewidth=0.5, label="$\sigma_{23}/2 - θ_0$", color=reduced_second_community_color)
line8, = ax3.plot([], [], ".", markersize=1, linewidth=0.5, label="$\sigma_{34}/2 - θ_0$", color=reduced_third_community_color)
line9, = ax3.plot([], [], ".", markersize=1, linewidth=0.5, label="$\sigma_{41}/2 - θ_0$", color=reduced_fourth_community_color)
...
line10, = ax4.plot([], [], label="$c_{1234}$", color=first_community_color)
line11, = ax4.plot([], [], label="$c_{0123}$", color=second_community_color)
